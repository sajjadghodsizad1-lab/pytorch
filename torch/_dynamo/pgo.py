...
def merge_pgo_entry(src: FrameStateSizeEntry, dst: FrameStateSizeEntry) -> FrameStateSizeEntry:
    def rank(entry):
                ...
                for code_id, state in code_state.items():
                    if code_id in _CODE_STATE:
                        for src, entry in state.automatic_dynamic.items():
                            ...
                            merge_pgo_entry(entry, _CODE_STATE[code_id].automatic_dynamic[src])
                    else:
