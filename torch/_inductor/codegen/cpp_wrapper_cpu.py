...
class CppWrapperCpu(PythonWrapperCodegen):
        ...
        with debug_printer_manager:
            ...
            if enable_kernel_profile:
                ...
                shim_fn_codes = [
                    ...
                    f"""RAIIAtenRecordFunctionHandle record_{shim_fn}_("{shim_fn}{debug_handle_str}", nullptr);""",
                    shim_fn_codes[0],
                    "}",
                ]
    ...
    def _generate_extern_kernel_out_helper(
        ...
        self.generate_c_shim_extern_kernel_call(
            kernel, args, device, debug_handle=debug_handle, stack_traces=stack_traces
        )
